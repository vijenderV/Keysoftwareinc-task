...
<div class="form-container">
    <%--@elvariable id="smartPhone" type="com.restaurentmanagement.model.Smartphones"--%>

    <form:form action="/RestaurentManagementSystem_war_exploded/smartPhones/updateSmartPhone"
               method="post" modelAttribute="smartPhone">
